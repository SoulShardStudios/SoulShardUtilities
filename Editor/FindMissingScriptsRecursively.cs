...
// Completely copied from https://github.com/PixelFireXY/FindMissingScriptsRecursively
// Will make a fork or something later
...
public class FindMissingScriptsRecursively : EditorWindow
{
    ...
    private readonly string instructionsText =
        "WARNING: If you have to remove the missing components, \nand the gameobject in the scene is a prefab, \nmake sure to do it on the asset prefab or unpack the prefab in the scene, \notherwise you will lose the changes when you press play.";
    ...
    private static void FindInGo(GameObject g)
    {
        ...
        if (missingComponentsCount > 0 && autoRemove)
        {
            ...
            if (removedComponents <= 0)
                Debug.LogError(
                    $"Cannot remove automatically the component at {s}. Please remove it manually.",
                    g
                );
            else
            {
