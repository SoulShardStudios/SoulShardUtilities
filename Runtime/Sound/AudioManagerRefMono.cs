...
namespace SoulShard.Utils
{
    ...
    public class AudioManagerRefMono : MonoBehaviour
    {
        ...
        public void PlaySoundCommand(string SoundName) => AudioManager.Instance.PlaySound(SoundName);
        /// <summary>
        /// stop a specific sound from playing
        /// </summary>
        /// <param name="SoundName">the name of the sound to stop playing</param>
        public void StopSoundCommand(string SoundName) => AudioManager.Instance.StopSound(SoundName);
    }
}